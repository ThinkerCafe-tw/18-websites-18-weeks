#!/usr/bin/env python3
"""
Build a single-HTML book preview from 19 markdown lecture files.
Usage: python3 build-book.py
Output: book-preview.html in the same directory.
"""
...
INPUT_DIR = os.path.join(SCRIPT_DIR, "01-教材內容")
OUTPUT_FILE = os.path.join(SCRIPT_DIR, "book-preview.html")
